...
All logs are saved to a file in the the specified dir. The recording takes place in a file corresponding to the current date, and the file changes on the following day. Log files are stored for the specified time - savingDays.
...
func main() {
    ...
    logger.Info("Hello!", "message level", lever)
